<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
	...
	<div>
		<h2 class="text-3xl text-gray-800 font-bold lg:text-4xl dark:text-white">
			Submit your very own piano design
		</h2>
		<p class="mt-3 text-gray-800 dark:text-gray-400">
			A panel of Adjudicators will rate and select the top designs. Those who are selected will
			participate in the Sing for Hope Pianos Program.
		</p>
		...
		<div class="px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
			<div class="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-3 xl:gap-6">
				...
				<a class="group flex gap-y-6 w-full h-full hover:bg-gray-100 rounded-lg p-5 transition-all dark:hover:bg-white/[.075]"
					...
					<div>
						<div>
							<h3 class="block font-bold text-gray-800 dark:text-white">Download the PDF
								Template</h3>
							<p class="text-gray-600 dark:text-gray-400">Download our PDF template to get started. This
								includes the guidelines.</p>
						</div>
				...
				<a class="group flex gap-y-6 w-full h-full hover:bg-gray-100 rounded-lg p-5 transition-all dark:hover:bg-white/[.075]"
					...
					<div>
						<div>
							<h3 class="block font-bold text-gray-800 dark:text-white">Print & sketch your
								design</h3>
							<p class="text-gray-600 dark:text-gray-400">Print the templates and sketch out your best
								design proposal within the template areas.</p>
						</div>
				...
				<a class="group flex gap-y-6 w-full h-full hover:bg-gray-100 rounded-lg p-5 transition-all dark:hover:bg-white/[.075]"
					...
					<div>
						<div>
							<h3 class="block font-bold text-gray-800 dark:text-white">Upload your design
							</h3>
							<p class="text-gray-600 dark:text-gray-400">Take a photo or scan your design and
								upload to submit.</p>
						</div>
